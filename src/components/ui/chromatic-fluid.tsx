...
void main() {
  ...
  vec3 lightBeige = vec3(0.96, 0.94, 0.86);
  
  vec3 specular = (specR * deepBlue + specG * cyan + specB * lightBeige) * 1.5; 
...
const ChromaticFluid = ({
  ...
  return (
    ...
    >
      ...
      {bottomFade && (
        <div 
          className="absolute inset-0 w-full h-full pointer-events-none backdrop-blur-xl"
          style={{
            WebkitMaskImage: 'linear-gradient(to bottom, transparent 10%, rgba(0,0,0,0.7) 40%, black 100%)',
            maskImage: 'linear-gradient(to bottom, transparent 10%, rgba(0,0,0,0.7) 40%, black 100%)'
          }}
        />
      )}
